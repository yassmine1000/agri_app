...
class _MarketPricesScreenState extends State<MarketPricesScreen> {
  ...
  final Map<String, Map<String, String>> _plants = {
    ...
    'Courgette':        {'EN': 'Zucchini',         'FR': 'Courgette',        'AR': 'قرع أخضر'},
    ...
    'Poire':            {'EN': 'Pear',             'FR': 'Poire',            'AR': 'إجاص'},
    ...
    'Mandarine':        {'EN': 'Mandarin',         'FR': 'Mandarine',        'AR': 'مدنينة'},
    'Fraise':           {'EN': 'Strawberry',       'FR': 'Fraise',           'AR': 'فريز'},
    'Cerise':           {'EN': 'Cherry',           'FR': 'Cerise',           'AR': 'كرز'},
    'Prune':            {'EN': 'Plum',             'FR': 'Prune',            'AR': 'عوينة'},
    ...
    'Pamplemousse':     {'EN': 'Grapefruit',       'FR': 'Pamplemousse',     'AR': 'زنباع'},
    ...
    'Seigle':           {'EN': 'Rye',              'FR': 'Seigle',           'AR': 'قميح'},
    'Triticale':        {'EN': 'Triticale',        'FR': 'Triticale',        'AR': 'قمح شيلمي'},
    'Riz':              {'EN': 'Rice',             'FR': 'Riz',              'AR': 'أرز'},
    'Millet':           {'EN': 'Millet',           'FR': 'Millet',           'AR': 'دخن'},
    'Épeautre':         {'EN': 'Spelt',            'FR': 'Épeautre',         'AR': 'قمح الحنطة'},
    ...
    'Coriandre':        {'EN': 'Coriander',        'FR': 'Coriandre',        'AR': 'تابل'},
