...
import '../utils/product_recommendation_box.dart';
...
class DiseaseView extends StatelessWidget {
      ...
      body: BlocBuilder<DiseaseBloc, DiseaseState>(
        builder: (context, state) {
          if (state is DiseaseInitial)
            return _buildPickOptions(context, l, isDark);
          if (state is DiseaseLoading)
            return _buildLoading(state.selectedImage, l, isDark);
          if (state is DiseaseSuccess)
            return _buildResult(context, state, l, isDark);
          if (state is DiseaseError)
            return _buildError(context, state.error, l, isDark);
  ...
  Widget _buildPickOptions(
    ...
    return SingleChildScrollView(
      ...
      child: Column(children: [
        ...
        Text(l.leafAnalysisDesc,
            textAlign: TextAlign.center,
            style:
                TextStyle(fontSize: 13, color: textSecondary, height: 1.6)),
        ...
        Container(
          ...
          child: Material(
            ...
            child: InkWell(
              borderRadius: BorderRadius.circular(16),
              onTap: () =>
                  context.read<DiseaseBloc>().add(PickImageFromCameraEvent()),
              child: Padding(
                padding:
                ...
                child: Row(children: [
                  Container(
                    ...
                    child:
                        Icon(Icons.camera_alt_rounded, color: bg, size: 22),
                  ),
                  ...
                  Column(
                      ...
                      children: [
                        ...
                        Text(l.useCamera,
                            style: TextStyle(
                                fontSize: 12, color: bg.withOpacity(0.7))),
                      ]),
                  const Spacer(),
                  Icon(Icons.arrow_forward_ios,
                      size: 14, color: bg.withOpacity(0.7)),
                ]),
              ),
            ),
          ),
        ...
        Container(
          ...
          child: Material(
            ...
            child: InkWell(
              borderRadius: BorderRadius.circular(16),
              onTap: () =>
                  context.read<DiseaseBloc>().add(PickImageEvent()),
              child: Padding(
                padding:
                    const EdgeInsets.symmetric(horizontal: 20, vertical: 16),
                child: Row(children: [
    ...
    return SingleChildScrollView(
      ...
      child: Column(children: [
        ...
        DetectionResultBox(
          ...
          plantName: state.plantName,         // ← traduit
          diseaseLabel: state.diseaseLabel,   // ← traduit
  ...
  Widget _buildError(BuildContext context, String error, AppLocalizations l,
      bool isDark) {
    final primary = isDark ? AppColors.primary : AppColorsLight.primary;
      ...
      child: Padding(
        ...
        child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
          Container(
            ...
            child:
                Icon(Icons.error_outline_rounded, color: errorColor, size: 36),
          ),
          const SizedBox(height: 16),
          ...
          ElevatedButton(
            ...
            child: Text(l.tryAgain,
                style: TextStyle(
                    color: bg, fontWeight: FontWeight.w700)),
          ),
        ]),
      ),
    );
