...
class _QrDisplayScreenState extends State<QrDisplayScreen> {
  ...
  Future<void> _saveToGallery(bool isDark, AppLocalizations l) async {
          ...
          child: WillPopScope(
            ...
            child: Scaffold(
              ...
              appBar: AppBar(
                ...
                title: Text(l.yourQrCode, style: TextStyle(color: textPrimary, fontWeight: FontWeight.w700)),
              ...
              body: SingleChildScrollView(
                ...
                child: Column(children: [
                  ...
                  Text(l.accountCreated, style: TextStyle(fontSize: 20, fontWeight: FontWeight.w800, color: primary)),
                  const SizedBox(height: 6),
                  Text(l.saveYourQr, textAlign: TextAlign.center, style: TextStyle(fontSize: 13, color: textSecondary, height: 1.5)),
                  ...
                  Container(
                    ...
                    child: ElevatedButton.icon(
                      onPressed: _saving ? null : () => _saveToGallery(isDark, l),
                      ...
                      label: Text(
                        _saved ? l.qrDownloaded : l.downloadToGallery,
                  ...
                  Container(
                    ...
                    child: Row(children: [
                      ...
                      const SizedBox(width: 10),
                      Expanded(child: Text(l.qrProfileNote, style: TextStyle(color: textSecondary, fontSize: 12, height: 1.5))),
                    ]),
                  ),
                  ...
                  SizedBox(
                    ...
                    child: OutlinedButton(
                      ...
                      child: Text(l.continueToLogin, style: TextStyle(color: primary, fontWeight: FontWeight.w700, fontSize: 14)),
                    ),
                  ),
